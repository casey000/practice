...
//      console.log(this.axiosLinkSearch,'this.axiosLinkSearch');
        this.showPop = false;
...
//          console.log(typeData,'typeData')
            $.ajax({
              ...
              data:{
                ...
                'minPrice' : vm.searchData.minPrice,
                'pageNum' : vm.pageNum,
                'pageSize' : vm.pageSizeData,
                'type' : typeData,
                'sortDir' : vm.searchData.sortDir,
                'sortBy' : vm.searchData.sortBy,//升序 降序
                'openid' : sessionStorage.openid,
              },
              dataType:'json',
              type:'post',
...
//      console.log(typeData,'typeData');
        ...
        $.ajax({
          ...
          success:function (data) {
            // console.log("返回值：",data);
            vm.proDetailData = data.data;
//          console.log('产品初始列表',vm.proDetailData)
            if(data.code == 1){
...
//      console.log(this.upDown,this.wNum,i);
      ...
      hidePopup : function(){
        this.showPop = false;
        this.isShowBlackCover = false;
//      console.log('最低价',this.getStartPrice)
//      console.log('最高价',this.getEndPrice)
      },
      resetClicl : function(){
        // this.axiosLinkSearch = false;
        this.searchData.keyword = null;
