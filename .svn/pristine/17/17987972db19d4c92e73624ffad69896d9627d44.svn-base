<template>
  <div class="pro-detail-content" v-title data-title="商品详情">
  	<div id="searchBar">
       ...
       <!-- <span class="video_font" >视频</span>-->
        <div class="pro-infos f-oh">
          <div class="pro-main-pic b-white f-fl">
            <div class="pic-show-here f-pr">

              <!--<video id="video" width="200" height="200"  playsinline webkit-playsinline="true" controls  v-if="isShowVideo">
                <source :src=videoSrc type="video/mp4">
              </video>
              <div class="close-btn" @click="closeVideo" v-if="isShowVideo">
                <i class="icon iconfont icon-close" style="font-size: 2rem"></i>
              </div>-->
    ...
    <!--上次到这里-->
      ...
      <div class="p-lef-rig20 f-oh b-white" v-if="giftList.length > 0" style="line-height: 4.0625rem;margin: 1.25rem 0;">
        <span style="font-size: 1.7rem">赠品</span>
        <div v-for="gift in giftList" style="display: block">
          <img class="img-pic f-fl" :src=gift.imgUrl :alt="gift.giftName" :title="gift.giftName" style="height: 8rem;width: 8rem;margin: 0 1rem 0.5rem 1rem">
         <!-- <p class="word f-fl fontSize-14" style="overflow: hidden;text-overflow: ellipsis;display: -webkit-box;-webkit-line-clamp:2; -webkit-box-orient: vertical;max-width: 15rem;line-height: 2.5rem;">{{gift.giftName}}</p>-->
        </div>
      </div>
          ...
          <ul class="collect-pro-comm-main f-oh">
            ...
            <li class="collect-pro-comm-row f-fl">
              ...
              <dt class="fontSize-12 collect">评论</dt>
				...
				<div class="mix-pro-comm b-white" v-if="combinepro.length!=0">
						<p class="mix-pro-comm-title fontSize-14">试试这样搭</p>
						<div class="mix-pro-comm-lunbo" style="height:12rem">
							<swiper  :options="swiperOption"  ref="mySwiper" height="12rem">
					      <swiper-item class="black" v-for="(item,i) in combinepro" :key="i">
					      	<router-link :to="{ path: '/home/mixproDetailRouter', query: { id: item.id}}">
					      		<img :src=item.imgPath class="f-fl m-right20 m-left20" style="width:12rem;height:12rem; display: inline-block; ">
						      	<p class=" fontSize-16 p-top12" style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis">{{item.title}}</p>
						      	<p class=" fontSize-16 p-top12" style="font-size: 1.5rem;color: grey">搭配价</p>
                    <p class=" fontSize-16 p-top12 " style="color: red;"><span style="font-size: 1.5rem">¥</span> {{item.combinationPrice}}</p>
					      	</router-link>
					      </swiper-item>
					    </swiper>
						</div>
        ...
        <div class="collect-store-btn b-white">
          <ul class="collect-main fontSize-15 f-oh">
            ...
            <li class="collect-btn-row f-fl">
              <a class="router" href="javascript:void(0)" @click="toChatNow">
        ...
        <!--&lt;!&ndash;不同选项内容切换插件&ndash;&gt;-->
        <div class="details-all b-white m-top10 fontSize-15" style="min-height: 70rem;">
        	<!--<div >-->
          <mt-navbar class="page-part" v-model="selecteda" id="nav-fixed">
          ...
          <mt-tab-container v-model="selecteda">
            <mt-tab-container-item id="1">
                <div class="xiangxi" v-html="content" style="min-height: 70rem;"></div>
              <!--<div style="width: 100%;">-->
                <!--<img style='width: 100%;' :src="item.src" alt="" v-for="(item,i) in testImg" :key="i">-->
              <!--</div>-->
            </mt-tab-container-item>
            <mt-tab-container-item id="2">
                <div class="xiangxi" v-html="guigeContent" style="min-height: 70rem;"></div>
            </mt-tab-container-item>
            <mt-tab-container-item id="3">
              <div class="xiangxi" v-html="shouHouSevice" style="min-height: 70rem;"></div>
            </mt-tab-container-item>
            <mt-tab-container-item id="4">
              <div class="comment-content xiangxi" style="min-height: 70rem;">
                <ul class="comment-main">
                  <li class="comment-row fontSize-13" v-for="(comMain,i) in comContent" :key="i">
                    <div class="comment-top f-oh">
                      ...
                      <p style="float: right;color: gray">{{comMain.skuName}}</p>
                    </div>
                    <div class="div_img" v-if="comMain.imgs != null">
                      <img :src="img" v-for="img in comMain.imgs" @click="showPj($event)">
                    </div>
    ...
    <div class="pingjia-img" v-if="showPjimg" >
				<img :src=pjimg >
		</div>
    <!--&lt;!&ndash;产品规格弹窗&ndash;&gt;-->
      ...
      <div class="popup-main">
        <div class="pro-img-infos f-oh">
          ...
          <div class="pro-word f-fl">
            ...
            <p class="pro-price fontSize-15" >￥{{skuPrice}}</p>
          </div>
        </div>
        ...
        <div class="choose-spec">
          <ul class="spec-main fontSize-14">
            ...
            <li class="spec-main-row" v-for="(spec,i) in shaixuanData" :key="i">
              ...
              <div class="choose-detail f-fl f-oh">
                  <span class="choose-option f-fl"
                        ...
                        @click = 'chooseItem(spec,item,i, $event)'
            ...
            <li class="spec-main-row f-oh">
              ...
              <div class="choose-detail add-reduce-main f-fl f-oh" v-if="productData.typeNo != 4">
                <p class="add-reduce-btns f-fl" @click="reduceBtn">-</p>
                <span class="buy-total-num f-fl"><input id="number" v-model.number="buyCount" pattern="[0-9]*" type="number" min = "1"  @blur="fanwei()"/></span>
                <!--<span class="buy-total-num f-fl">{{buyCount}}</span>-->
                <p class="add-reduce-btns f-fl" @click="addBtn">+</p>
              </div>
              <!--限购商品-->
              <div class="choose-detail add-reduce-main f-fl f-oh" v-if="productData.typeNo == 4">
                <p class="add-reduce-btns f-fl">-</p>
                <span class="buy-total-num f-fl">{{buyCount}}</span>
                <p class="add-reduce-btns f-fl">+</p>
              </div>
            </li>
        ...
        <div class="addCart-confirm-btns fontSize-16 f-oh" v-if="productData.typeNo != 4">
        ...
        <div class="addCart-confirm-btns fontSize-16 f-oh" v-if="productData.typeNo == 4">
          <dt class="confirm addCart-confirm-btn f-fl" style="width: 100%;" @click="confirmOrder()">立即抢购</dt>
        </div>
      </div>
    </div>
    ...
    <div class="buy-btn-content b-white f-oh">
      ...
      <!--开售并未购买过-->
      <div class="buy-btn f-fr fontSize-15" v-if="setTime == '' && productData.isLimit == 0">
        <div class="btn-wai f-fl f-oh">
          <span class="btn-inner f-fr buy" @click="showBuyNow()">买</span>
        </div>
        <div class="btn-wai f-fl f-oh" v-if="productData.isLimit == 0">
          <span class="btn-inner f-fr sale" @click="maijianglijin">卖</span>
        </div>
      </div>
      <!--开售并已购买过-->
      <div class="daishou" v-if="setTime == '' && productData.isLimit == 1">
        <div class="daishoubtn" style="width: 100%;text-align: center">
          <span class="" style="background-color: grey">您已购买过该商品</span>
        </div>
      </div>
      <!--未售-->
      <div class="daishou" v-if="setTime != ''">
        <div class="daishoubtn" style="width: 100%;text-align: center">
          <span class="" v-if="productData.isLimit == 1" style="background-color: grey">您已购买过该商品</span>
          <span class="" v-else>{{setTime}}</span>
        </div>
      </div>
      ...
      <!--<div v-if="isCall" class="call-popup f-pr">
        ...
        <dt class="btn-main fontSize-14 f-oh">
          ...
          <a href="tel:40008000"><div class="confirm-btn btns">确定</div></a>
        </dt>
      </div>-->
    </div>
    <!--<div class="playvideo">
...
<style>
  .details-all .xiangxi img{
    width: 100%;
  }
  .details-all .xiangxi{
  	padding: 0 1rem;
  }
  /*.pic-show-here .mint-swipe-item img{*/
    /*width: 100%;*/
  /*}*/
</style>
<script>
...
/*  import Video from '@/../static/video/zy.media.min.js';*/
...
//          return this.buyCount = this.storeNum;
//      }
//    },
     methods : {
     	fanwei(){
//   		var e=e.srcElement || e.target
//				this.buyCount=$(e).value.replace(/[^\d]/g,'')
     		if(this.buyCount < 1){
     			 Toast({
             message: '购买数量输入有误',
             duration: 2000
       ...
       daojishi(leftTime){//173057506
     	...
     	showPj(e){
     		this.pjimg=$(e.srcElement).attr('src')
     		this.showPjimg=true;
           ...
           success:function (data) {
             if(data.code == 1){
               if(sessionStorage.openid == null || sessionStorage.openid == 'null' || sessionStorage.openid == undefined || sessionStorage.openid == 'undefined') {
                 ...
                 _vm.carCount = data.data.carCount;
               }
               _vm.proDetailData = data.data;//获取店铺数据 --对象
               _vm.productId = data.data.product.id;
//             console.log(_vm.proDetailData);
               ...
               //开售倒计时
               if(_vm.productData.countDown != '' && _vm.productData.countDown != null && _vm.productData.countDown != undefined && _vm.productData.countDown != 'undefined' && _vm.productData.countDown != 'null') {
                 var leftTime = _vm.proDetailData.product.countDown;
                 if(leftTime>0){
               ...
               let newFenqiShu = _vm.productData.period.split(',');
//             console.log('newFenqiShu',newFenqiShu);
               ...
               let fenqiArray = _vm.productData.periodArray;
               for(var j = 0,jl = fenqiArray.length;j < jl;j ++){
                 _vm.fenqiShu[j].label = fenqiArray[j];
                 _vm.fenqiShu[j].checked = false;
               }
//             console.log('fenqiShu',_vm.fenqiShu)
               _vm.productData.logo = comLink.yxtImgHost + _vm.productData.logo;
               _vm.skuPrice = _vm.productData.mallPrice;
               setTimeout(function(){//点击第一张图片展示视频
                 _vm.content = _vm.productData.introduction;
               },500);
               _vm.guigeContent = _vm.productData.specification;
               _vm.shouHouSevice = _vm.productData.agreement;
               if(_vm.productData.mulImgArray){
...
//             console.log(_vm.skuShowLists,'sku');
               ...
               setTimeout(function(){//点击第一张图片展示视频
                 $('.vux-swiper .vux-img').eq(0).on('click',function(){
                   _vm.isShowVideo = true;
                 })
               },500);

               // _vm.getPeriodAxios();//获取分期数
               _vm.proJieshaoAxios();
               // _vm.shouHouSeviceAxios();//售后服务信息
             }
           },
           error:function (data) {
         ...
         if(!this.skuProObj){
           Toast({
             ...
             duration: 2000
          	...
          	this.isBlackCoverShow = false;
            // 动态更新购物车数量
           this.carCount = this.carCount*1 + $('#number').val()*1;
         }
       },
       getSkuItems(t){
         var specParamsIDStr = this.specParamsIDArr.join(',');
//       console.log(specParamsIDStr ,'specParamsIDStr');
...
//           console.log(this.skuProObj,'46789');
             this.skuPrice = this.skuShowLists[i].salePrice;
       ...
       proJieshaoAxios: function(){
         ...
         $.ajax({
           ...
           success:function (data) {
             if(data.code == 1){
               vm.comContent = data.data.commentVOList;
               /*for(var i=0; i<vm.comContent.length; i++) {
                 for(var j=0; j<vm.comContent[i].imgs.length; j++) {
                   vm.comContent[i].imgs[j] = comLink.yxtHost + vm.comContent[i].imgs[j];
                 }
               }*/
               vm.comNum = data.data.count;
               // Toast({
               //   //mintui提示效果
               //   message: data.msg,
               //   duration: 2000
       ...
       makrWechat() {
         window.open('https://mp.weixin.qq.com/s?__biz=MzU0Mjc5MzEyMw==&mid=2247483771&idx=1&sn=f16de57ab798c0b902410f851db25a07&chksm=fb140db7cc6384a1c814be4c231b69c5abe562f91e2beb905efaae1a80663ca07b432103e30d#rd', '_target');
         /*Toast({
           message: '建设中...敬请期待！',
           duration: 2000
         });*/
...
//       this.isCall = true;
         this.isContactWaysShow = false;
         this.isBlackCoverShow = false;
// 					MessageBox.confirm('确定要拨打客服电话?').then(action => {
             window.location.href = 'tel://' + this.phoneNumber;
//        });
       },
       toChatNow(){//直接聊天
        	$('#chat').click()
//        window.location.href = comLink.yxtHost + '/user/v5kf';
       },
       copy : function () {
...
//       console.log(this.specParamsIDArr[index]);
         // specParamsIDArr
         this.getSkuItems(t);
       },
       ...
       getGift() {
         ...
         let hash = window.location.hash;
         let id = hash.split('=')[1];
         $.post(comLink.yxtHost + '/product/productGift', {
           'productId' : id
         }, function(resp) {
           if(resp.code == 1) {
             vm.giftList = resp.data;
             for(var i = 0; i < vm.giftList.length; i++){
               vm.giftList[i].imgUrl = comLink.yxtImgHost + vm.giftList[i].imgUrl;
             }
           }
         });
       },
     ...
     mounted:function(){
       ...
       $(window).scroll(function(){
					...
					let offsetTop = $('#searchBar').height();
		         ...
		         openid: (sessionStorage.openid == undefined || sessionStorage.openid == null || sessionStorage.openid == 'undefined' || sessionStorage.openid == 'null') ? '' : sessionStorage.openid,
		     		...
		     		success:function(data){
		     			if(data.code==1){
		     				...
		     				for(var i=0;i<_vm.combinepro.length;i++){
		     					_vm.combinepro[i].imgPath=comLink.yxtImgHost+_vm.combinepro[i].imgPath
		     				}
		     			}
		          ...
		          if(data.code==1){
			        ...
			        wx.ready(function() {
				        	...
				        	wx.onMenuShareAppMessage({ //朋友
							        title: '邮讯通商城龙卡专区',
							        desc: _vm.productData.name,
							        link: 'https://www.yxtccb.com/yxt/#/home/proDetailRouter?id='+_vm.productId,
	//						        link: _vm.productUrl,
							        imgUrl: _vm.lunboUrl[0].img,
							        success: function() {
					        ...
					        wx.onMenuShareTimeline({
					            ...
					            desc: _vm.productData.name,
					            link: 'https://www.yxtccb.com/yxt/#/home/proDetailRouter?id='+_vm.productId,
					            imgUrl: _vm.lunboUrl[0].img, // 分享图标
					            success: function () {
					                // 用户确认分享后执行的回调函数
					            },
					            cancel: function () {
...
<style lang="scss" scoped>
  ...
  /*@import "@/../static/video/zy.media.min.css"; //导入scss初始文件*/
  .daishou{
  	width: 57%;
    height: 5rem;
    color: white;
