<template>
  <div class="tuikuan-content" v-title data-title="申请售后">
    ...
    <div class="tuikuan-money" v-if="notHuanhuo">
      <p v-if="!flag"><span class="f-fl fontSize-14">可退款金额：</span><span class="fontSize-14" style="color: red">¥ <input id="payprice" class="fontSize-14" type="number" :max=payPrice v-model="price" style="color: red"/></span></p>
      <!--<p>仅可退款金额：<span style="color: #e61414;font-size: 2.5rem;font-weight: 500">¥{{price}}</span></p>-->
      <p v-else><span class="f-fl fontSize-14">退款金额：</span><span class="fontSize-14" style="color: red">¥ <input class="fontSize-14" :value="price2" style="color: red" readonly="readonly"/></span></p>
        ...
        <li v-for="(proItem,j) in productList" :key="j">
          ...
          <div class="content clearfix">
            ...
            <div class="f-fl" style="width: 30%;">
              <div class="ellipsis fontSize-14  price" style="text-align: right;"> ￥ {{proItem.insidePrice}}</div>
        ...
        $.post(comLink.yxtHost + "/order/afterSaleApply", {
          ...
          if(res.code == 1) {
            ...
            vm.$router.push({
              ...
              query: {
                'orderId': vm.$route.query.insideOrderId
              }
            });
          } else {
            vm.flag = false;
...
//        'openid' : sessionStorage.openid,
    ...
    mounted(){
      ...
      let orderId = vm.$route.query.orderId;//传递过来的id
      let afterOrderId = vm.$route.query.afterOrderId;//传递过来的id
      let skuId = vm.$route.query.skuId;
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          for(var i=0;i<vm.productList.length;i++){
            ...
            vm.number = vm.maxNum;
            vm.skuId = skuId;
            vm.price = vm.price*1 + vm.productList[i].insidePrice*1;
      ...
      $.ajax({
        ...
        success:function(data){
          if(data.code==1){
            ...
            vm.skuprice=data.data.order.realAmount;
          }
        }
      });
    }
