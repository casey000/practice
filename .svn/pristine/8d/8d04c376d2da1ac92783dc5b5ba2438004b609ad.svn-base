<template>
  <div  class="edit-address-content fontSize-14" v-title data-title="编辑地址">
    <div class="address-main">
      ...
      <div class="set-moren-address f-oh fontSize-11 p-lef-rig24" @click="chooseAdd">
        <i class="choosed-icon f-fl" :class="{ 'choosed' : saveData.isDefault}"></i>
        <span class="word f-fl m-left5">设为默认地址</span>
      </div>
    </div>
