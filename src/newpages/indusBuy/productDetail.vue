  ...
  <div class="pro-detail-content" v-title data-title="商品详情">
        ...
        <div class="pro-infos f-oh">
          ...
          <div class="fenqi-ways  m-top10 b-white fontSize-15 f-fl">
            <div class="price-main p-lef-rig20 f-oh">
              <dt class="new-price f-fl fontSize-15 m-right15" v-if="productData.mallPrice > 0" style="color: #ff675f">实付：￥{{productData.insidePrice}}</dt>
              <s class="old-price f-fl fontSize-10">官网价：￥{{productData.mallPrice}}</s>
    ...
    <div class="buy-btn-content b-white f-oh">
      ...
      <div class="buy-btn f-fr fontSize-15">
        <div class="btn-wai f-fl f-oh" style="width: 100%">
          <span class="btn-inner f-fr buy" @click="showBuyNow()">立即购买</span>
        </div>
      </div>
   ...
   export default{
     ...
     methods : {
       ...
       proDetailAxios:function(){
         var _vm = this;
         $.ajax({
           url:comLink.yxtHost + '/inside/product/productDetails',
           data:{
             'openid': sessionStorage.openid,
           ...
           success:function (data) {
             if(data.code == 1){
               ...
               _vm.skuPrice = _vm.productData.insidePrice;
       ...
       addCartAxios: function(){
         var _vm = this;
         $.ajax({
           url:comLink.yxtHost + '/inside/car/addProduct',
           data:{
             'openid': sessionStorage.openid,
             'insideId': sessionStorage.insideId,
             'insideSkuId' : _vm.skuId,//sku数字
       ...
       getSkuItems(t){
         ...
         if(count == this.skuShowLists.length && this.specParamsIDArr.length > 1) {
           this.skuPrice = '';
           this.storeNum = 0;
           this.buyCount = 0;
         }
...
//        window.location.href = comLink.yxtHost + '/user/v5kf';
     ...
     mounted:function(){
      this.productId = window.location.hash.split('=')[1];
