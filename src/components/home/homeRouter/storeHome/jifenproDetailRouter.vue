<template>
  <div class="pro-detail-content" v-title data-title="积分商品详情">
  	<div id="searchBar">
        ...
        <div class="pro-infos f-oh">
          ...
          <div class="fenqi-ways  m-top10 b-white fontSize-15 f-fl">
            ...
            <div class="price-main p-lef-rig20 f-oh">
              <dt class="new-price f-fl fontSize-15 m-right10" v-if="productData.mallPrice > 0">
              	 <span v-if="productData.integral>0 ">消耗: {{productData.integral}} 积分</span>
              </dt>
    ...
    <!--上次到这里-->
      ...
      <!--<div class="p-lef-rig20 f-oh b-white" v-if="giftList.length > 0" style="line-height: 4.0625rem;margin: 1.25rem 0;">
        ...
        <div v-for="gift in giftList" style="display: block">
          <img class="img-pic f-fl" :src=gift.imgUrl :alt="gift.giftName" style="height: 8rem;width: 8rem;margin: 0 1rem 0.5rem 1rem">
        </div>
      </div>-->
            ...
            <li class="collect-pro-comm-row f-fl">
              ...
              <dt class="fontSize-12 collect">评论</dt>
				...
				<!--<div class="mix-pro-comm b-white" v-if="combinepro.length!=0">
						...
						<div class="mix-pro-comm-lunbo" style="height:20rem">
							<swiper  :options="swiperOption"  ref="mySwiper" height="20rem">
					      <swiper-item class="black" v-for="(item,i) in combinepro" :key="i">
					      	<router-link :to="{ path: '/home/mixproDetailRouter', query: { id: item.id}}">
					      		<img :src=item.imgPath style="" class="f-fl m-right20" style="width:23rem;height:20rem; display: inline-block; ">
						      	<p class=" fontSize-16 p-top20 ">{{item.title}}</p>
						      	<p class=" fontSize-16 p-top20 ">搭配价</p>
						      	<p class=" fontSize-16 p-top20 " style="color: red;">¥ {{item.combinationPrice}}</p>
					      	</router-link>
					      </swiper-item>
					    </swiper>
						</div>
      ...
      <div class="popup-main">
        <div class="pro-img-infos f-oh">
          ...
          <div class="pro-word f-fl">
            ...
            <p class="pro-price fontSize-15" >{{productData.integral}} 积分</p>
          </div>
        </div>
        ...
        <div class="addCart-confirm-btns fontSize-16 f-oh">
          ...
          <dt class="confirm addCart-confirm-btn f-fl" @click="confirmOrder()">立即兑换</dt>
          <!--</router-link>-->
        </div>
      </div>
    </div>
    ...
    <div class="buy-btn-content b-white f-oh">
      ...
      <div class="buy-btn f-fr fontSize-15" >
        <div class="btn-wai f-fl f-oh">
          <span class="btn-inner f-fr buy" @click="showBuyNow()">兑换</span>
        </div>
        <div class="btn-wai f-fl f-oh">
...
<style>
  ...
  .mix-pro-comm .vux-slider > .vux-indicator, .vux-slider .vux-indicator-right {
   display: none;
}
   ...
   export default{
     ...
     methods : {
       ...
       proDetailAxios:function(){
         ...
         _vm.productId = proId;
         $.ajax({
           url:comLink.yxtHost + '/product/integralProductDetails',
           data:{
             id : proId,
       ...
       confirmOrderAxios: function(){
         ...
         if(!this.skuProObj){
           ...
           $.ajax({
             url:comLink.yxtHost + '/car/postIntegralOrder',
             data:{
             ...
             success:function (data) {
               if(data.code == 1){
                 ...
                 _vm.$router.push({
                   path : "/home/jifenconfirmOrderRouter",
       ...
       toChatNow(){//直接聊天
         ...
         if(hour < 9 || hour > 18) {
           ...
           if(sessionStorage.openid == null || sessionStorage.openid == 'null' || sessionStorage.openid == undefined || sessionStorage.openid == 'undefined' || sessionStorage.openid == '') {
             ...
             window.open('http://yxtccb.com:8080/chat/wab/index?openid=' + sessionStorage.openid, '_target');
           }
         }
       },
       copy : function () {
