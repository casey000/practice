<template>
  <div class="serach-pro-content"  v-title data-title="积分兑换">
    <scroller height="-0.01" lock-x @on-scroll-bottom="scrollerRequire"  ref="myScroller">
      <div>
        ...
        <jifenpripro-component :proDetailData = 'proDetailData'></jifenpripro-component>
      </div>
...
<script>
  ...
  import jifenpriproComponent from "./../../../subcomponents/jifenpripro-component.vue";
  export default {
    name : 'duihuanjifen',
    directives: {
      TransferDom
    ...
    watch: {
      '$route'(to,from) {
        ...
        if(from.name !== 'proDetailRouter' && to.name == 'duihuanJifen'){
          this.$nextTick(() => {
